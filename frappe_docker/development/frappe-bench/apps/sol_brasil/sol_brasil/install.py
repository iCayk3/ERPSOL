...
CUSTOM_FIELDS = {
	...
	"Subscription": [
		...
		{"fieldname": "custom_network_section", "fieldtype": "Section Break", "label": "Equipamentos e rede óptica", "insert_after": "custom_effective_rate_limit"},
...
def reorder_subscription_tabs():
	...
	provider_fields = [
		...
		"custom_effective_rate_limit", "custom_network_section",
